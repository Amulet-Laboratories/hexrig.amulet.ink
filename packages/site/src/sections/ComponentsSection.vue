    ...
    <div class="max-w-6xl mx-auto space-y-6">
      ...
      <div class="bg-surface-raised border border-border-subtle rounded-theme p-8 sm:p-10">
        ...
        <div class="flex flex-wrap items-center gap-4">
          <button class="inline-flex items-center justify-center rounded-theme font-body font-medium transition-colors duration-normal ease-standard px-4 pt-[7px] pb-[9px] text-base min-h-[40px] bg-accent text-text-on-accent hover:bg-accent-hover active:bg-accent-active focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring">
            Primary
          </button>
          ...
          <button class="inline-flex items-center justify-center rounded-theme font-body font-medium transition-colors duration-normal ease-standard px-4 pt-[7px] pb-[9px] text-base min-h-[40px] text-accent hover:bg-accent-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring">
            Ghost
          </button>
          ...
          <button class="inline-flex items-center justify-center rounded-theme font-body font-medium transition-colors duration-normal ease-standard px-4 pt-[7px] pb-[9px] text-base min-h-[40px] bg-status-error text-text-inverse hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring">
            Danger
          </button>
          <button class="inline-flex items-center justify-center rounded-theme font-body font-medium px-4 pt-[7px] pb-[9px] text-base min-h-[40px] bg-accent text-text-on-accent opacity-50 pointer-events-none" disabled>
      ...
      <!-- Row 2: Cards + Input side by side -->
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-surface-raised border border-border-subtle rounded-theme p-8 sm:p-10">
          ...
          <div class="space-y-4">
            <div class="bg-surface-base border border-border rounded-theme overflow-hidden">
              <div class="px-4 pt-4 pb-2 border-b border-border-subtle">
                <span class="font-display text-base text-text-primary">Flat</span>
              </div>
              <div class="p-4">
                <p class="text-sm text-text-secondary">No elevation. Grounded in the surface.</p>
              </div>
            </div>
            <div class="bg-surface-raised shadow-md rounded-theme overflow-hidden">
              <div class="px-4 pt-4 pb-2 border-b border-border-subtle">
                <span class="font-display text-base text-text-primary">Raised</span>
              </div>
              <div class="p-4">
                <p class="text-sm text-text-secondary">Lifted from the surface. Default state.</p>
              </div>
            </div>
            <div class="bg-surface-raised shadow-lg rounded-theme overflow-hidden cursor-pointer hover:shadow-xl transition-shadow duration-normal">
              <div class="p-4">
        ...
        <div class="bg-surface-raised border border-border-subtle rounded-theme p-8 sm:p-10">
          ...
          <div class="space-y-5">
            <div class="flex flex-col gap-1.5">
              <label class="font-body text-sm font-medium text-text-primary">Display name</label>
              <input
                type="text"
                value="Amulet"
                class="block w-full rounded-theme border bg-surface-sunken px-3 py-2 font-body text-base text-text-primary placeholder:text-text-muted shadow-inner transition-colors duration-fast border-border hover:border-border-strong focus:outline-none focus:border-focus-ring focus:ring-2 focus:ring-focus-ring"
              />
              <p class="text-sm text-text-muted">Your public display name.</p>
            </div>
            <div class="flex flex-col gap-1.5">
              <label class="font-body text-sm font-medium text-text-primary">
                Email <span class="text-status-error ml-0.5">*</span>
              </label>
              <input
                type="email"
            ...
            <div class="flex flex-col gap-1.5">
              <label class="font-body text-sm font-medium text-text-primary">Error state</label>
              <input
                type="text"
                value="invalid"
                class="block w-full rounded-theme border bg-surface-sunken px-3 py-2 font-body text-base text-text-primary shadow-inner border-status-error focus:outline-none focus:border-focus-ring focus:ring-2 focus:ring-focus-ring"
              />
              <p class="text-sm text-status-error">This field is required.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-surface-raised border border-border-subtle rounded-theme p-8 sm:p-10">
          ...
          <div class="space-y-3">
            <div class="flex items-start gap-3 p-4 rounded-theme border border-status-success/30 bg-surface-raised">
            ...
            <div class="flex items-start gap-3 p-4 rounded-theme border border-status-warning/30 bg-surface-raised">
            ...
            <div class="flex items-start gap-3 p-4 rounded-theme border border-status-error/30 bg-surface-raised">
            ...
            <div class="flex items-start gap-3 p-4 rounded-theme border border-border bg-surface-raised">
        ...
        <div class="bg-surface-raised border border-border-subtle rounded-theme p-8 sm:p-10">
          ...
          <div class="space-y-6">
            ...
            <div class="flex items-center gap-4">
              ...
              <span class="text-xs text-text-muted font-mono">Typography</span>
              <div class="flex-1 h-px bg-border-subtle" />
            </div>
