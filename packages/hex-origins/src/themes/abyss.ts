...
export const abyss: HexTheme = {
  ...
  name: 'Abyss',
  narrative:
    'Nothingness. The space between stars — vast, electric, and alive with potential. Cold cosmos humming with latent energy.',
  ...
  fonts: {
    ...
    sans: {
      ...
      italic: false,
      rationale:
        'Derived from Space Mono with proportional spacing. Angular, geometric, slightly alien.',
    },
    mono: {
      ...
      italic: true,
      rationale:
        "From GitHub's Monaspace superfamily — Neon is the sans-serif variant with texture healing. The most technically advanced free monospace available.",
    },
  },
