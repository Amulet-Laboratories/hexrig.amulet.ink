...
export const hollow: HexTheme = {
  ...
  name: 'Hollow',
  narrative:
    'Growth. Life pushing through stone, roots finding water in darkness. The third act — organic persistence, the quiet power of things that grow slowly and never stop.',
  ...
  fonts: {
    display: {
      ...
      italic: true,
      rationale:
        'A variable old-style serif with axes for weight, optical size, softness, and "wonk." It introduces organic irregularity into the letterforms, as if the type itself is growing.',
    },
    body: {
      family: 'Vollkorn',
      ...
      italic: true,
      rationale:
        'Friedrich Althausen\u0027s "quiet and modest" serif designed for everyday reading. Its name means "whole grain" in German — earthy, nourishing, substantial.',
    },
    sans: {
      family: 'DM Sans',
      source: 'Google Fonts',
      ...
      italic: true,
      rationale:
        'Low-contrast geometric sans from Colophon Foundry. Soft, grounded, and designed for small sizes.',
    },
    mono: {
      family: 'Commit Mono',
      ...
      italic: true,
      rationale:
        'A neutral monospace that uses "smart kerning" — optically adjusts spacing without breaking monospace alignment. Quiet, precise, and surprisingly organic in feel.',
    },
  },
